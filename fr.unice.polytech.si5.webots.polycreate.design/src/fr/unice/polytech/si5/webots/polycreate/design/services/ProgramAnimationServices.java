package fr.unice.polytech.si5.webots.polycreate.design.services;
...
public class ProgramAnimationServices extends AbstractGemocAnimatorServices {
	...
	protected List<StringCouple> getRepresentationRefreshList() {
		...
		res.add(new StringCouple("program", "Animation"));
