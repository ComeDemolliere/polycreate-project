...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.si5.webots.polycreate.abstractsyntax.polycreate.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PolycreatePackage.Literals.STATE__TRANSITIONS);
			childrenFeatures.add(PolycreatePackage.Literals.STATE__ACTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case PolycreatePackage.STATE__TRANSITIONS:
		case PolycreatePackage.STATE__ACTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(PolycreatePackage.Literals.STATE__TRANSITIONS,
		...
		newChildDescriptors.add(createChildParameter(PolycreatePackage.Literals.STATE__ACTIONS,
				PolycreateFactory.eINSTANCE.createMoveAction()));
