...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.si5.webots.polycreate.abstractsyntax.polycreate.AngleCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AngleConditionItemProvider extends ObjectConditionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AngleConditionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addAnglePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AngleCondition_angle_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_AngleCondition_angle_feature",
	...
	/**
	 * This returns AngleCondition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AngleCondition"));
	}
	...
	public String getText(Object object) {
		CAMERATYPE labelValue = ((AngleCondition) object).getCameraType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_AngleCondition_type")
				: getString("_UI_AngleCondition_type") + " " + label;
	}
